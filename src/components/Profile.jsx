        ...
        {myAds.length > 0 && (
          <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
            {[
              ...
              { label: "Venduti", value: myAds.filter(a => a.status === "sold").length, color: "#0f3d38", bg: "#F0F000" },
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              <div style={{ display: "flex", gap: 4 }}>
                {[
                  ...
                  { value: "sold", label: "Venduto", activeColor: "#0f3d38", activeBg: "#F0F000", activeBorder: "#c8c800" },
