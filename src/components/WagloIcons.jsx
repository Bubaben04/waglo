...
export const IconCani = ({ size = 24, color = "currentColor", strokeWidth = 2.2 }) => (
  <svg width={size} height={size} viewBox="-4 -4 56 56" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
    <path d="M4,16 Q-4,22 -2,32 Q0,40 8,40" strokeWidth={strokeWidth}/>
    <path d="M44,16 Q52,22 50,32 Q48,40 40,40" strokeWidth={strokeWidth}/>
    <rect x="8" y="4" width="32" height="30" rx="8"/>
    <circle cx="16" cy="16" r="3.5" fill={color} stroke="none"/>
    <circle cx="32" cy="16" r="3.5" fill={color} stroke="none"/>
    <ellipse cx="24" cy="26" rx="8" ry="6"/>
    <ellipse cx="24" cy="26" rx="3.5" ry="2.5" fill="#F0F000" stroke="none"/>
    <path d="M16,34 Q24,42 32,34"/>
  </svg>
);
...
export const IconUccelli = ({ size = 24, color = "currentColor", strokeWidth = 2.2 }) => (
  <svg width={size} height={size} viewBox="-4 -4 56 56" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M8,26 Q2,22 4,14 Q14,18 18,22" stroke="#F0F000"/>
    <path d="M7,32 L1,28"/>
    <path d="M7,36 L1,40"/>
...
export const IconPesci = ({ size = 24, color = "currentColor", strokeWidth = 2.2 }) => (
  <svg width={size} height={size} viewBox="-4 -4 56 56" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M36,15 L46,6 L46,42 L36,33Z"/><line x1="46" y1="6" x2="46" y2="42" stroke="#F0F000" strokeWidth="2.2"/>
...
export const IconRoditori = ({ size = 24, color = "currentColor", strokeWidth = 2.2 }) => (
  <svg width={size} height={size} viewBox="-4 -4 56 56" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
    ...
    <circle cx="10" cy="14" r="10" stroke="#F0F000"/>
    ...
    <circle cx="24" cy="36" r="1.5" fill="#F0F000" stroke="none"/>
...
export const IconAltri = ({ size = 24, color = "currentColor", strokeWidth = 2.2 }) => (
  <svg width={size} height={size} viewBox="-4 -4 56 56" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round">
    <path d="M0,16 Q0,16 10,16 L0,30 Q0,30 10,30" strokeWidth="2.8"/>
    <ellipse cx="22" cy="23" rx="9" ry="12" strokeWidth="2.8"/>
    <ellipse cx="38" cy="23" rx="9" ry="12" strokeWidth="2.8"/>
    <line x1="-2" y1="38" x2="46" y2="38" strokeWidth="1.6"/>
    <circle cx="48" cy="38" r="3" fill="#F0F000" stroke="none"/>
  </svg>
);
